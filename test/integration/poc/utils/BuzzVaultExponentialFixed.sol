...
import {BuzzVault, SafeERC20, IERC20} from "../../../../contracts/BuzzVault.sol";
...
contract BuzzVaultExponential is BuzzVault {
    ...
    error BuzzVaultExponential_InvalidK();
    ...
    function _buy(
        ...
        if (info.k > info.baseBalance * info.tokenBalance) {
            revert BuzzVaultExponential_InvalidK();
        }
    ...
    function _calculateBuyPrice(
        ...
        uint256 amountAux = quoteBalance -
            ((k / (baseBalance + baseAmountIn)) + 1);
    ...
    function _calculateSellPrice(
        ...
        amountOut = baseBalance - ((k / (quoteBalance + quoteAmountIn)) + 1);
    }
